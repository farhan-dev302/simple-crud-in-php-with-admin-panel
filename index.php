...
$numTeamMembers = mysqli_num_rows($result);
?>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <h3 class="my-3"><?php echo  $numTeamMembers ?></h3>
                                <span class="badge badge-soft-primary mr-1"> +11% </span> <span class="text-muted">From
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <span class="badge badge-soft-primary mr-1"> -29% </span> <span class="text-muted">This
                                    Month</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <span class="badge badge-soft-primary mr-1"> 0% </span> <span class="text-muted">This
                                    Month</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <span class="badge badge-soft-primary mr-1"> +89% </span> <span class="text-muted">This
                                    Month</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        ?>
                                    <a href="#" class="d-flex align-items-center border-bottom py-3">
                                        <div class="mr-3">
                                            <img src="<?php echo $imageURL; ?>" class="rounded-circle avatar-sm"
                                                alt="user">
                                        </div>
                                        <div class="w-100">
                                            ...
                                            <p class="text-muted font-size-13 mb-0"><?php echo $phone_number; ?></p>
                                        </div>
                                    </a>
                                    <?php
                        }
